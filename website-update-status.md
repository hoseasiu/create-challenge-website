...
| [maker-skills.html](maker-skills.html) | [/create-challenge/create-course/maker-skills](https://beaver-works-assistive-tech.mit.edu/create-challenge/create-course/maker-skills) | 2026-07-12 | ✅ Synced | 2026-07-12 | Was marked synced 2026-06-13, but a fresh `check-styles.py` run on 2026-07-12 found 3 drift issues (`.callout-card` padding, `.callout-card__body` font-size, `.reflect-box` margin-top) the earlier push missed. Fixed, then removed `target="_blank"` from 6 internal links (maker-skills sub-pages). Pasted live and confirmed by user 2026-07-12. |
